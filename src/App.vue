      ...
      <div class="row property__gallery">
        <div class="col-lg-3 col-md-4 col-sm-6 mix">
          <div class="product__item">
            <div
              ...
              data-setbg="assets/img/product/calzas-moma.png"
            >
              <div class="label new">New</div>
              <ul class="product__hover">
                <li>
                  <a href="assets/img/product/calzas-moma.png" class="image-popup"
            ...
            <div class="product__item__text">
              <h6><a href="#">Calzas psicodélicas</a></h6>
              <div class="rating">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mix">
          <div class="product__item">
            <div
              class="product__item__pic set-bg"
              data-setbg="assets/img/product/capa-moma.jpg"
            >
              <ul class="product__hover">
                <li>
                  <a href="assets/img/product/capa-moma.jpg" class="image-popup"
                    ><span class="arrow_expand"></span
                  ></a>
                </li>
                <li>
            ...
            <div class="product__item__text">
              <h6><a href="#">Capa de malvada de Disney</a></h6>
              <div class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mix">
          <div class="product__item">
            <div
              class="product__item__pic set-bg"
              data-setbg="assets/img/product/tunica-sombrero-moma.jpg"
            >
              <div class="label stockout">out of stock</div>
              <ul class="product__hover">
                <li>
                  <a href="assets/img/product/tunica-sombrero-moma.jpg" class="image-popup"
                    ><span class="arrow_expand"></span
                  ></a>
                </li>
                <li>
            ...
            <div class="product__item__text">
              <h6><a href="#">Combo túnica sombrero Shaolin</a></h6>
              <div class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mix">
          <div class="product__item">
            <div
              class="product__item__pic set-bg"
              data-setbg="assets/img/product/pollera-buzo-galactico-moma.jpg"
            >
              <ul class="product__hover">
                <li>
                  <a href="assets/img/product/pollera-buzo-galactico-moma.jpg" class="image-popup"
                    ><span class="arrow_expand"></span
                  ></a>
                </li>
                <li>
            ...
            <div class="product__item__text">
              <h6><a href="#">Pollera + buzo galáctico</a></h6>
              <div class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mix">
          <div class="product__item">
            <div
              class="product__item__pic set-bg"
              data-setbg="assets/img/product/vestido-jazz.jpg"
            >
              <ul class="product__hover">
                <li>
                  <a href="assets/img/product/vestido-jazz.jpg" class="image-popup"
                    ><span class="arrow_expand"></span
                  ></a>
                </li>
                <li>
            ...
            <div class="product__item__text">
              <h6><a href="#">Vestidito Bella y la Bestia</a></h6>
              <div class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
        ...
        >
          <div class="product__item sale">
            <div
              class="product__item__pic set-bg"
              data-setbg="assets/img/product/tapado-jonsnow.jpg"
            >
              <div class="label sale">Sale</div>
              <ul class="product__hover">
                <li>
                  <a href="assets/img/product/tapado-jonsnow.jpg" class="image-popup"
                    ><span class="arrow_expand"></span
                  ></a>
                </li>
                <li>
            ...
            <div class="product__item__text">
              <h6><a href="#">Tapado Jon Snow</a></h6>
              <div class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
        ...
        >
          <div class="product__item">
            <div
              class="product__item__pic set-bg"
              data-setbg="assets/img/product/blusa-sexy.jpg"
            >
              <ul class="product__hover">
                <li>
                  <a href="assets/img/product/blusa-sexy.jpg" class="image-popup"
                    ><span class="arrow_expand"></span
                  ></a>
                </li>
                <li>
            ...
            <div class="product__item__text">
              <h6><a href="#">Blusa Sexy multi-age</a></h6>
              <div class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
        ...
        >
          <div class="product__item sale">
            <div
              class="product__item__pic set-bg"
              data-setbg="assets/img/product/vestido-kubrick.jpg"
            >
              <div class="label">Sale</div>
              <ul class="product__hover">
                <li>
                  <a href="assets/img/product/vestido-kubrick.jpg" class="image-popup"
                    ><span class="arrow_expand"></span
                  ></a>
                </li>
                <li>
            ...
            <div class="product__item__text">
              <h6><a href="#">Vestido Kubrick</a></h6>
              <div class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
